    ...
    <form class="forder-form" @submit.prevent="submit">
        <div class="container">
            <div class="py-5 text-center">
                ...
                <p class="h6 font-lg mt-3">주문 내역을 확인하시고 주문하기 버튼을 클릭해 주세요.</p>
            </div>
            <div class="row g-5">
                <div class="col-md-5 col-lg-4 order-md-last">
                    <div class="mb-3">
                        ...
                        <span class="badge bg-primay rounded-pill align-middle">{{ state.items.length }}</span>
                    </div>
                    ...
                    <button class="w-100 btn btn-primary py-4 mt-4">결제하기</button>
                </div>
